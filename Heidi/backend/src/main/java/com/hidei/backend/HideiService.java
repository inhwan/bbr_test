...
import com.hidei.backend.model.CompressDecorator;
import com.hidei.backend.model.DecompressDecorator;
import com.hidei.backend.model.DecryptionDecorator;
import com.hidei.backend.model.EncryptionDecorator;
...
public class HideiService {
    ...
    private HideiController hideiController;
